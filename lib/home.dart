...
class _HomeState extends State<Home> {
  ...
  final TextStyle customTextStyle = TextStyle(
    fontFamily: 'letra', // Nombre de la fuente definido en pubspec.yaml
  ...
  Widget build(BuildContext context) {
    ...
    final ThemeData appTheme = ThemeData.dark().copyWith(
      primaryColor:
          Color.fromARGB(255, 19, 55, 214), // Color azul para la AppBar
      scaffoldBackgroundColor:
          Color.fromARGB(0, 0, 0, 0), // Fondo negro del cuerpo
      canvasColor: Color.fromARGB(255, 21, 0, 113), // Fondo oscuro del Drawer
    );
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          backgroundColor: Color.fromARGB(255, 0, 38, 142),
          // Barra de navegación superior (AppBar) con un título y un botón de búsqueda
          title: Text("MovieApp-200570"), // Título de la aplicación
          actions: <Widget>[
            IconButton(
              icon: Icon(
                Icons.search,
              ...
              new DrawerHeader(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage('assets/zelda3.jpg'),
                        fit: BoxFit.cover)),
